        ...
        extends CoderOutputStream
{
    ...
    public LzmaOutputStream(final OutputStream out, final LZMAEncoder lzmaEncoder)
            throws IOException
    {
    ...
    public static class Builder
    {
        ...
        private int matchFinder = LZMAEncoder.EMatchFinderTypeBT4;
        ...
        {
            matchFinder = LZMAEncoder.EMatchFinderTypeBT4;
            return this;
        }

        public Builder useBT2MatchFinder()
        {
            matchFinder = LZMAEncoder.EMatchFinderTypeBT2;
            return this;
        }
