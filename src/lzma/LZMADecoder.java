...
public class LZMADecoder
{
    class LenDecoder
    {
        ...
        public void init()
        {
            lzma.Decoder.initBitModels(m_Choice);
        ...
        public int decode(lzma.Decoder rangeDecoder, int posState) throws IOException
        {
    ...
    class LiteralDecoder
    {
        class Decoder2
        {
            ...
            public void init()
            {
                lzma.Decoder.initBitModels(m_Decoders);
            }

            public byte decodeNormal(lzma.Decoder rangeDecoder) throws IOException
            {
                int symbol = 1;
                do
                {
            ...
            public byte decodeWithMatchByte(lzma.Decoder rangeDecoder, byte matchByte) throws IOException
            {
                int symbol = 1;
                do
                {
    ...
    private final lzma.Decoder m_RangeDecoder = new lzma.Decoder();
    ...
    void init() throws IOException
    {
        ...
        lzma.Decoder.initBitModels(m_IsMatchDecoders);
        lzma.Decoder.initBitModels(m_IsRep0LongDecoders);
        lzma.Decoder.initBitModels(m_IsRepDecoders);
        lzma.Decoder.initBitModels(m_IsRepG0Decoders);
        lzma.Decoder.initBitModels(m_IsRepG1Decoders);
        lzma.Decoder.initBitModels(m_IsRepG2Decoders);
        lzma.Decoder.initBitModels(m_PosDecoders);
